...
router.put("/:spotId", requireAuth, async (req, res) => {
  try {
    ...
    // i dont think that this commented out part is needed, due to the validations/constraints on the model itself
...
router.post("/:spotId/bookings", requireAuth, async (req, res) => {
  try {
    ...
    //   errorObj.endDate = "End date conflicts with an an existing booking"
    // }
